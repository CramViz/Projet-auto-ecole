...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2023 at 08:40 PM
...
CREATE TABLE `categorie` (
  ...
  `Libelle` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `eleve` (
  ...
  `Adresse1` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CodePostal` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
